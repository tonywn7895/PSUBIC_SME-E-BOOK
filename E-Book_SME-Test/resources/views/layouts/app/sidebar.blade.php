        ...
        <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:sidebar.nav>
                <flux:sidebar.group :heading="__('Menu')" class="grid">
                    ...
                    <flux:sidebar.item icon="book-open" :href="route('ebooks.index')" :current="request()->routeIs('ebooks.*')" wire:navigate>
                        {{ __('E-book Library') }}
                    </flux:sidebar.item>

                    <flux:sidebar.item icon="table-cells" :href="route('spreadsheets.index')" :current="request()->routeIs('spreadsheets.*')" wire:navigate>
                        {{ __('Data Tables') }}
                    </flux:sidebar.item>

                    <flux:sidebar.item icon="photo" :href="route('carousel.index')" :current="request()->routeIs('carousel.*')" wire:navigate>
                        {{ __('Public Carousel') }}
                    </flux:sidebar.item>
